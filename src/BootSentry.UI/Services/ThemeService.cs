...
public class ThemeService : IDisposable
{
    ...
    public void ApplyTheme()
    {
        ...
        if (isDark)
        {
            ...
            resources["SuccessBrush"] = new SolidColorBrush(Color.FromRgb(4, 120, 87));
            resources["WarningBrush"] = new SolidColorBrush(Color.FromRgb(180, 83, 9));
            resources["ErrorBrush"] = new SolidColorBrush(Color.FromRgb(185, 28, 28));
            resources["InfoBrush"] = new SolidColorBrush(Color.FromRgb(29, 78, 216));
            resources["SuccessSoftBrush"] = new SolidColorBrush(Color.FromArgb(26, 4, 120, 87));
            resources["WarningSoftBrush"] = new SolidColorBrush(Color.FromArgb(26, 180, 83, 9));
            resources["ErrorSoftBrush"] = new SolidColorBrush(Color.FromArgb(26, 185, 28, 28));
            resources["RiskSafeBrush"] = new SolidColorBrush(Color.FromRgb(4, 120, 87));
            resources["RiskUnknownBrush"] = new SolidColorBrush(Color.FromRgb(107, 114, 128));
            resources["RiskSuspiciousBrush"] = new SolidColorBrush(Color.FromRgb(180, 83, 9));
            resources["RiskCriticalBrush"] = new SolidColorBrush(Color.FromRgb(185, 28, 28));
            resources["StatusEnabledBrush"] = new SolidColorBrush(Color.FromRgb(4, 120, 87));
            resources["StatusDisabledBrush"] = new SolidColorBrush(Color.FromRgb(185, 28, 28));
            resources["StatusUnknownBrush"] = new SolidColorBrush(Color.FromRgb(107, 114, 128));
    ...
    private static void ApplyHighContrastTheme(ResourceDictionary resources)
    {
        ...
        resources["SuccessSoftBrush"] = new SolidColorBrush(Color.FromArgb(80, SystemColors.HighlightColor.R, SystemColors.HighlightColor.G, SystemColors.HighlightColor.B));
        resources["WarningSoftBrush"] = new SolidColorBrush(Color.FromArgb(80, SystemColors.HighlightColor.R, SystemColors.HighlightColor.G, SystemColors.HighlightColor.B));
        resources["ErrorSoftBrush"] = new SolidColorBrush(Color.FromArgb(80, SystemColors.HighlightColor.R, SystemColors.HighlightColor.G, SystemColors.HighlightColor.B));
        resources["RiskSafeBrush"] = new SolidColorBrush(SystemColors.HighlightColor);
        resources["RiskUnknownBrush"] = new SolidColorBrush(SystemColors.GrayTextColor);
        resources["RiskSuspiciousBrush"] = new SolidColorBrush(SystemColors.HighlightColor);
        resources["RiskCriticalBrush"] = new SolidColorBrush(SystemColors.HighlightColor);
        resources["StatusEnabledBrush"] = new SolidColorBrush(SystemColors.HighlightColor);
        resources["StatusDisabledBrush"] = new SolidColorBrush(SystemColors.HighlightColor);
        resources["StatusUnknownBrush"] = new SolidColorBrush(SystemColors.GrayTextColor);
