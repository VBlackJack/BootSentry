...
public static class Strings
{
    private static readonly Dictionary<string, Dictionary<string, string>> Resources = new()
    {
        ["fr"] = new Dictionary<string, string>
        {
            ...
            ["History_Entry"] = "Entrée",
            ["History_Status"] = "Statut",
            ["History_Loading"] = "Chargement de l'historique...",
            ["History_Count"] = "{0} transactions",
            ["History_LoadError"] = "Erreur lors du chargement de l'historique",
            ["History_Restoring"] = "Restauration en cours...",
            ["History_RestoreSuccess"] = "Restauration effectuée avec succès",
            ["History_RestoreError"] = "Erreur lors de la restauration: {0}",
            ["History_Purged"] = "{0} anciennes transactions supprimées",
            ["History_PurgeError"] = "Erreur lors de la purge",
            ["History_CanRestore"] = "Restaurable",
            ["History_CannotRestore"] = "Non restaurable",
            ["History_Restored"] = "Restauré",
            ["History_PurgeButton"] = "Purger les anciens",
            ["History_RestoreButton"] = "Restaurer",
        ...
        ["en"] = new Dictionary<string, string>
        {
            ...
            ["History_Count"] = "{0} transactions",
            ["History_LoadError"] = "Error loading history",
            ["History_Restoring"] = "Restoring...",
            ["History_RestoreSuccess"] = "Restore completed successfully",
            ["History_RestoreError"] = "Error during restore: {0}",
            ["History_Purged"] = "{0} old transactions deleted",
            ["History_PurgeError"] = "Error during purge",
            ["History_CanRestore"] = "Can restore",
            ["History_CannotRestore"] = "Cannot restore",
            ["History_Restored"] = "Restored",
            ["History_PurgeButton"] = "Purge old",
            ["History_RestoreButton"] = "Restore",
            ["History_User"] = "User",
            ["History_Type"] = "Type",
